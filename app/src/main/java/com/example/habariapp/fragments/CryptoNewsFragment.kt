...
class CryptoNewsFragment : Fragment(R.layout.fragment_crypto_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                    R.id.action_cryptoNewsFragment_to_articleFragment,
                    bundle
            )
        }
...
/*        var job: Job? = null
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if(shouldPaginate) {
                ...
                ctCryptoNews.setPadding(0, 0, 0, 0)
            }
        }
    ...
    private fun setupRecyclerView() {
        ...
        ctCryptoNews.apply {
            ...
            addOnScrollListener(this@CryptoNewsFragment.scrollListener)
        }
    }
